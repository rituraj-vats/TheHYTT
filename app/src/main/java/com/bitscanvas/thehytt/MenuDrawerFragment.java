...
import com.bitscanvas.thehytt.adapters.MenuDrawerAdapter;
...
public class MenuDrawerFragment extends Fragment {
    ...
    public  List<MenuItems> getData() {
        List<MenuItems> data = new ArrayList<>();
        // preparing navigation drawer items
        for (int i = 0; i < titles.length; i++) {
            MenuItems navItem = new MenuItems();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.menu_fragment_drawer, container, false);
